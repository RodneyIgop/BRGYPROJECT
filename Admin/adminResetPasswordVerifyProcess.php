...
// Check if admin password reset session exists
if (!isset($_SESSION['admin_password_reset'])) {
...
$reset_session = $_SESSION['admin_password_reset'];
...
$_SESSION['admin_password_reset']['verified'] = true;
$_SESSION['admin_password_reset']['verified_at'] = date('Y-m-d H:i:s');
