            ...
            <tbody id="pendingBody">
                ...
                if($result && $result->num_rows>0){
                    while($row = $result->fetch_assoc()){
                        ...
                        echo '<a href="#" class="action-icon view-btn" data-id="'.$row["RequestID"].'" data-fullname="'.htmlspecialchars($row["fullname"],ENT_QUOTES).'" data-date="'.htmlspecialchars($row["dateRequested"],ENT_QUOTES).'" data-doc="'.htmlspecialchars($row["documenttype"],ENT_QUOTES).'" data-label="Print file" style="display:none;"><img src="../images/print.png" alt="view" style="width:28px;height:28px; "></a>';
